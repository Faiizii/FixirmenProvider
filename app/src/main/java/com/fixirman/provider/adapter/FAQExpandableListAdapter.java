...
//    private HashMap<String, List<String>> _listDataChild;
    ...
    public FAQExpandableListAdapter(Context context, List<FAQModel> faqList) {
    ...
    public Object getChild(int groupPosition, int childPosititon) {
        return this.faqList.get(groupPosition)
                .getAnswer();
    }
    ...
    public Object getGroup(int groupPosition) {
        return this.faqList.get(groupPosition).getQuestion();
    }
